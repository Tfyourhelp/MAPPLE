...
export default class extends Controller {
  ...
  newuserForm () {
    ...
    $('.btn-new-form-submit').on('click', function(event) {
      ...
      if (email.length == 0){
        ...
        $('.input-email').closest('.el-email').find('.invalid-error').html('')
      }
      ...
      if (password.length == 0){
        ...
        $('.input-password').removeClass('correct-input')
        $('.input-password').addClass('error-input')
        $('.input-password').closest('.el-password').find('.invalid-error').html('Password length must be greater than 6')
        isValid = false;
      }
      else{
        $('.input-password').removeClass('error-input')
        $('.input-password').addClass('correct-input')
        $('.input-password').closest('.el-password').find('.invalid-error').html('')
      }
      ...
      if (passwordConfirmation.length == 0){
        ...
        $('.input-password-confirmation').removeClass('correct-input')
        $('.input-password-confirmation').addClass('error-input')
        $('.input-password-confirmation').closest('.el-password-confirmation').find('.invalid-error').html('Password confirmation length must be greater than 6')
        isValid = false;
      }
  ...
  changeuserpasswordForm () {
    ...
    $('.btn-change-user-password-submit').on('click', function(event) {
      console.log('e')
      event.preventDefault();
      console.log('aaa')
      let isValid = true;

      const currentpassword = $('.input-currentpassword').val()
      if (currentpassword.length == 0){
        $('.input-currentpassword').removeClass('correct-input')
        $('.input-currentpassword').addClass('error-input')
        $('.input-currentpassword').closest('.el-currentpassword').find('.invalid-error').html('Please fill your current password')
        isValid = false;
      }
      else if (currentpassword.length < 6){
        $('.input-currentpassword').removeClass('correct-input')
        $('.input-currentpassword').addClass('error-input')
        $('.input-currentpassword').closest('.el-currentpassword').find('.invalid-error').html('Current password length must be greater than 6')
        isValid = false;
      }
      else{
        $('.input-currentpassword').removeClass('error-input')
        $('.input-currentpassword').addClass('correct-input')
        $('.input-currentpassword').closest('.el-currentpassword').find('.invalid-error').html('')
      }
      ...
      if (isValid == true){
        document.getElementById("ChangeUserPasswordForm").submit()
      }
    })
  }
  ...
  resetuserpasswordForm () {
    ...
    $('.btn-reset-user-password-submit').on('click', function(event) {
      event.preventDefault();
      let isValid = true;
      console.log('b')
      const password = $('.input-password').val()
      ...
      console.log('ccc')
      if (isValid == true){
        document.getElementById("ResetUserPasswordForm").submit()
      }
    })
  }
  ...
  infoorderForm () {
    ...
    $('.btn-info-form-submit').on('click', function(event) {
      console.log('e')
      event.preventDefault();
      console.log('aaa')
      let isValid = true;
